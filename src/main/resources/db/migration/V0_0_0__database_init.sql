...
CREATE TABLE `upload_invoice` (
  ...
  `invoice_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Date of invoice ',
  `due_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Due date of invoice ',
